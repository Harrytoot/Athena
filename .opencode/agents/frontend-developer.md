...
### Athena-Specific: Frontend
- Next.js 14 App Router + React 18 + TypeScript strict.
- Tailwind CSS 3.x + shadcn/ui + lucide-react icons. `frontend/` directory.
- Server Components for data fetching; "use client" only for interactivity.
- API calls via fetch() to FastAPI `/api/v1/`. shadcn/ui in `frontend/components/ui/`.
- Pages: Dashboard, Market, Watchlist, Stock Detail, Portfolio, Recommendations.
- Performance: LCP < 2.5s, FID < 100ms, CLS < 0.1. Lighthouse ≥90.
- a11y: WCAG 2.1 AA (shadcn/ui Radix primitives are a11y-first).
