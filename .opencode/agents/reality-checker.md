...
### Athena-Specific: Quality Gates
**Release certification checklist**:
1. Code review passed (no 🔴 blockers)
2. Tests pass (≥80% coverage, critical paths tested)
3. Documentation updated (ADRs, API docs, migration guides)
4. Evidence chains present for all AI-driven features
5. Confidence scores on all recommendations
6. Performance benchmarks met (<200ms p95, LCP <2.5s)
7. Security scan passed (no HIGH vulnerabilities)
8. DB migration tested (no data loss, rollback verified)
Gate: 1-5 block release. 6-8 flag for review but proceed.
