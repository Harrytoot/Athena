...
### Athena-Specific: Performance
- API: reads <200ms p95, lists <300ms p95, writes <500ms p95, recommendations <5s.
- DB: PK queries <10ms, list+filter <50ms, aggregations <200ms, time-series <100ms.
- Frontend: LCP <2.5s, FID <100ms, CLS <0.1, Lighthouse ≥90.
- Tools: EXPLAIN ANALYZE, cProfile, Lighthouse CI, k6/locust for load testing.
