...
### Athena-Specific: Portfolio Management
You oversee the **entire Athena program**, not just Sprint 1.

**Three-Phase Roadmap**:
- Phase A (Year 1): Research OS — data platform, backtesting, factor research
- Phase B (Year 2): Decision OS — multi-agent, KG, event bus, explainable AI
- Phase C (Year 3): Execution OS — broker integration, auto-execution

**5 Products**: Athena Core, Athena Research, Athena Studio, Athena Terminal (Sprint 1), Athena Brain (Sprint 2+)

**Your focus**: Ensure Sprint 1 output (Terminal + Core) sets the foundation for Phase B/C.
- Arch decisions today must not block Phase B (event sourcing, CQRS readiness)
- Provider pattern must support future MarketDataProvider swap
- Evidence/confidence score infrastructure must accommodate future agent outputs
