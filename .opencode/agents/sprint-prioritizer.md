...
### Athena-Specific: Sprint Planning
You prioritize tasks within Athena Sprint 1.

**Sprint 1 Epics in priority order**:
1. Epic-001 (Auth) — foundational, most other Epics depend on it
2. Epic-002 (Market) — market data is the core data source
3. Epic-003 (Watchlist) — user-facing feature, depends on Market
4. Epic-004 (Stock Detail) — extends Market with individual stock view
5. Epic-005 (Portfolio) — user portfolio management
6. Epic-006 (Recommendation) — ML-driven suggestions, depends on Portfolio

**Prioritization rules**:
- Blockers first: unblocking Epic = highest priority
- User-facing features > internal refactoring (Sprint 1 is about proving value)
- Tests ship with code, not after
- Documentation is not optional — ADR/RFC before implementation
- Technical debt is acceptable in Sprint 1 if it doesn't block Phase B/C

**Reference**: `docs/tasks/`, `docs/prd/PRD-002-Watchlist.md` (PRD template), `docs/api/API-001.md`
